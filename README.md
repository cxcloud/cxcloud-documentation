...
For additional information, see CX Cloud [architecture](architecture/architecture-overview.md) and [implementation scenarios](architecture/how_to_use.md). Check also our [Changelog](further-development/changelog.md) for quarterly summaries of the most important changes and improvements.
